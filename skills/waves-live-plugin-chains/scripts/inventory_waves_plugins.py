...
RULES = [
    ...
    Rule(("Vocal Rider",), "rider/leveler", "Automatic vocal level riding before/after compression.", "useful live", "Official latency is low; verify it follows worship phrasing instead of flattening it."),
    Rule(("Bass Rider", "PlaylistRider"), "rider/leveler", "Automatic bass or playlist level riding.", "useful with caution", "Bass Rider Live adds more latency than Vocal Rider; verify path latency and musical phrasing."),
    ...
    Rule(("X-FDBK", "Feedback Hunter"), "feedback control", "Feedback detection/suppression.", "useful live", "Potentially valuable for monitors/FOH, but verify CPU/load and do not replace good gain structure."),
    Rule(("Clarix LB", "Clarity Vx", "Clarity Vx Pro", "Clarity Vx DeReverb", "Clarity Vx DeReverb Pro", "WNS", "NS1", "W43", "X-Click", "X-Crackle", "X-Hum", "X-Noise", "Z-Noise", "DeBreath"), "noise/restoration", "Noise, breath, and restoration control.", "verify-first/broadcast", "Clarix LB is broadcast-only for this skill; other restoration tools are latency/CPU/support-sensitive and must be verified in the actual SuperRack target."),
