...
RULES = [
    ...
    Rule(("AudioTrack", "C1", "EMO-D5"), "channel dynamics", "Gate/expander/compressor basics and dynamics cleanup.", "useful live", "Good utility choices, though PSE/F6/RComp often fit our workflow better."),
